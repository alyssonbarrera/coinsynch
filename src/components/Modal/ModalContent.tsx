...
> = ({ children, ...props }, ref) => {
  return (
    <DialogContent
      ...
      className={twMerge(
        'fixed left-[50%] top-[50%] z-10 w-full max-w-[17rem] translate-x-[-50%] translate-y-[-50%] rounded-lg bg-white px-6 py-8 shadow-modal-shadow data-[state=open]:animate-contentShow md:max-w-xs md:px-6 xl:max-w-md xl:px-8',
        props.className,
      )}
    >
      {children}
