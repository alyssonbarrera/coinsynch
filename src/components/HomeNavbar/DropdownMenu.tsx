    ...
    <RadixDropdownMenu.Root {...props}>
      ...
      <RadixDropdownMenu.Portal>
        <RadixDropdownMenu.Content
          className="min-w-[220px] rounded-md bg-white p-[5px] text-label leading-label shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade data-[side=right]:animate-slideLeftAndFade data-[side=top]:animate-slideDownAndFade"
          sideOffset={5}
        >
          ...
          <RadixDropdownMenu.Item className="outline-none">
            <Button.Root className="h-8 min-w-[6.25rem] bg-transparent hover:bg-gray-50 hover:transition-colors">
              <Button.Content className="text-color-base">
                Sign In
              </Button.Content>
            </Button.Root>
          </RadixDropdownMenu.Item>
          <RadixDropdownMenu.Item className="outline-none">
            <Button.Root className="h-8 min-w-[6.25rem] flex-grow-0">
